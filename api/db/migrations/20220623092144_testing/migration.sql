...
INSERT INTO "new_Task" ("containerId", "customerId", "end", "id", "materialId", "plannedAt", "serviceId", "siteId",
                        "start", "workerId")
SELECT "containerId",
       "customerId",
       coalesce("end", CURRENT_TIMESTAMP)   AS "end",
       "id",
       "materialId",
       "plannedAt",
       "serviceId",
       "siteId",
       coalesce("start", CURRENT_TIMESTAMP) AS "start",
       "workerId"
FROM "Task";
DROP TABLE "Task";
